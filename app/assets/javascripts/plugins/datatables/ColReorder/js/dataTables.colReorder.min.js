...
(function(n, p, q) {
    ...
    $.fn.dataTableExt.oApi.fnColReorder = function(b, e, a) {
        var f = $.fn.dataTable.Api ? !0 : !1,
            c, d, g, l, j = b.aoColumns.length,
            h;
        if (e != a)
            if (0 > e || e >= j) this.oApi._fnLog(b, 1, "ColReorder 'from' index is out of bounds: " +
                e);
            else if (0 > a || a >= j) this.oApi._fnLog(b, 1, "ColReorder 'to' index is out of bounds: " + a);
        else {
            g = [];
            c = 0;
            for (d = j; c < d; c++) g[c] = c;
            ...
            c = 0;
            for (d = j; c < d; c++) h = b.aoColumns[c], "number" == typeof h.mData && (h.mData = k[h.mData], b.oApi._fnColumnOptions(b, c, {}));
            if (b.aoColumns[e].bVisible) {
                l = this.oApi._fnColumnIndexToVisible(b, e);
                h = null;
                for (c = a < e ? a : a + 1; null === h && c < j;) h = this.oApi._fnColumnIndexToVisible(b, c), c++;
                ...
                for (d = b.aoData.length; c <
                    d; c++) null !== b.aoData[c].nTr && o(b.aoData[c].nTr, l, h)
            }
            i(b.aoColumns, e, a);
            i(b.aoPreSearchCols, e, a);
            c = 0;
            for (d = b.aoData.length; c < d; c++) g = b.aoData[c], f ? (g.anCells && i(g.anCells, e, a), "dom" !== g.src && $.isArray(g._aData) && i(g._aData, e, a)) : ($.isArray(g._aData) && i(g._aData, e, a), i(g._anHidden, e, a));
            c = 0;
            ...
            c = 0;
            for (d = j; c < d; c++) $(b.aoColumns[c].nTh).off("click.DT"),
    ...
    n = function(b) {
        ...
        e.prototype = {
            ...
            _fnConstruct: function() {
                ...
                if (d)
                    if (a.s.dt._bInitComplete) b = m(d), a._fnOrderColumns.call(a, b);
                    else {
                        var g = !1;
            ...
            _fnStateSave: function(a) {
                ...
                a.ColReorder = [];
                f = 0;
                for (c = g.aoColumns.length; f < c; f++) d = g.aoColumns[f]._ColReorder_iOrigCol, a.aoSearchCols[d] = e[f], a.abVisCols[d] = g.aoColumns[f].bVisible, a.ColReorder.push(d)
            },
            ...
            _fnMouseDown: function(a, f) {
                var c = this,
                    ...
                    e = parseInt(b(f).attr("data-column-index"), 10);
            ...
            _fnRegions: function() {
                ...
                for (var f = 0, c = 0, d = a.length; c < d; c++) c != this.s.mouse.fromIndex && f++, a[c].bVisible && this.s.aoTargets.push({
            ...
            _fnCreateDragNode: function() {
                var a = "" !== this.s.dt.oScroll.sX || "" !== this.s.dt.oScroll.sY,
                    f = this.s.dt.aoColumns[this.s.mouse.targetIndex].nTh,
                    c = f.parentNode,
                    d = c.parentNode,
                    e = d.parentNode,
                    i = b(f).clone();
